      ...
      <b:section class='header' id='header' maxwidgets='1' showaddelement='no'>
        <b:widget id='Header1' locked='true' title='download app android (ط±ط£ط³ ط§ظ„طµظپط­ط©)' type='Header' version='1'>
          <b:widget-settings>
            ...
            <b:widget-setting name='sectionWidth'>203</b:widget-setting>
...
<b:else/>
  ...
  <div class='descriptionwrapper'>
    <p class='description' itemprop='description'><span><data:description/></span></p>
      ...
      <a expr:href='data:blog.homepageUrl' expr:title='data:title' itemprop='url'><span itemprop='name'>download app</span></a>
</b:includable>
        </b:widget>
      </b:section>
      </header>
...
//<![CDATA[
  ...
  input.onkeyup = function() {
    if (input.value != "") {
      output.value = "https://7stardownload.blogspot.com/p/blog-page.html?url=" + Base64.encode(this.value); //change with your link
    } else {
      output.value = "";
    }
  }
